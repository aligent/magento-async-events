...
class AddEntityTypeContext
{
     ...
     *
     * This looks like the only callee
     * @see vendor/magento/module-elasticsearch/Model/Adapter/Elasticsearch.php:191
     *
     * Always resolves to product (\Magento\Elasticsearch\Model\Adapter\BatchDataMapper\ProductDataMapper) if an
     * entityType context is not set.
